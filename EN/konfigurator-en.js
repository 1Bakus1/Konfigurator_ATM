...
{ 
  ...
  // for Internet Explorer
    ...
    alert("The product key has successfully been copied to the clipboard. Now just use the option of pasting in the email addressed to bok@atmlighting.pl");
  }
    ...
    selection.addRange(range);
		document.execCommand("Copy");
    alert("Successfully copied the product key to the clipboard, now just use the option to paste in the mail addressed to bok@atmlighting.pl or use the Send e-mail with query option");
	}
	}
