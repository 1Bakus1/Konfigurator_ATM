...
if($.browser.safari)
{
	informacja_przegladarka.innerHTML = "The application works correctly on browsers: Google Chrome, Mozilla Firefox and Opera. On other browsers the application may not work properly or not work at all."
}
...
{ 
  ...
  // for Internet Explorer
    ...
    alert("The product key has successfully been copied to the clipboard. Now just use the option of pasting in the email addressed to office@atmlighting.pl");
  }
    ...
    selection.addRange(range);
		document.execCommand("Copy");
    alert("Successfully copied the product key to the clipboard, now just use the option to paste in the mail addressed to office@atmlighting.pl or use the Send e-mail with query option");
	}
	}
function wyslijEmail() 
{
	var kluczMail = document.getElementById("klucz");
	tytulMaila = "Inquiry generated from the configurator";
...
function Selekcja_działu_opraw(wybrano)
	...
	if(wybrano == 'VANDAL')
		{
			dzialWyborFotometrii="/wandaloodporne-oprawy-oswietleniowe-do-infrastruktury-kolejowej-i-tuneli/";
		var ikona = document.getElementById("ikona");
			ikona.src="ikony/ikona_vandal.jpg";
			var obrazek = document.getElementById("obrazek");
			obrazek.src="vandal-en.jpg";
			var typ_oprawy1 = document.getElementById("1-typ_oprawy");
			typ_oprawy1.className = "row pokazane";
			var lista_typow_opraw = document.getElementById("wybor_typu_oprawy");
			//Show_all_lista_typow_opraw();
			lista_typow_opraw.options[10].disabled =false;
			lista_typow_opraw.options[2].disabled =false;
			lista_typow_opraw.options[3].disabled =false;
		}
	if(wybrano == 'PRISON')
		{
			dzialWyborFotometrii="/oprawy-oswietleniowe-do-zakladow-penitencjarnych-i-wiezien/";
			var ikona = document.getElementById("ikona");
			ikona.src="ikony/ikona_prison.jpg";
			var obrazek = document.getElementById("obrazek");
			obrazek.src="prison-en.jpg";
			var typ_oprawy1 = document.getElementById("1-typ_oprawy");
			typ_oprawy1.className = "row pokazane";
			var lista_typow_opraw = document.getElementById("wybor_typu_oprawy");
			//Show_all_lista_typow_opraw();
	...
	if(wybrano == 'FACTORY')
		{
			dzialWyborFotometrii="/oprawy-oswietleniowe-do-zakladow-produkcyjnych-i-hal-magazynowych/";
			var ikona = document.getElementById("ikona");
			ikona.src="ikony/ikona_industry.jpg";
			var obrazek = document.getElementById("obrazek");
			obrazek.src="factory-en.jpg";
			var typ_oprawy1 = document.getElementById("1-typ_oprawy");
			typ_oprawy1.className = "row pokazane";
			var lista_typow_opraw = document.getElementById("wybor_typu_oprawy");
			//Show_all_lista_typow_opraw();
	...
	if(wybrano == 'FOOD')
		{
			...
			dzialWyborFotometrii="/oprawy-oswietleniowe-do-przemyslu-spozywczego-i-hodowli-zwierzat/";
			var ikona = document.getElementById("ikona");
...
function Selekcja_strefy_wybuchowej(wybrano)
	{
		...
		if(wybrano == 'pierwsza')
		{
			...
			var obrazek = document.getElementById("obrazek");
			obrazek.src="strefa-1-exf-4-en.jpg";
			var typ_oprawy1 = document.getElementById("1-typ_oprawy");
			typ_oprawy1.className = "row pokazane";
			var lista_typow_opraw = document.getElementById("wybor_typu_oprawy");
			for(i=1; i <= lista_typow_opraw.options.length; i++)
		...
		if(wybrano == 'druga' || wybrano=='dwudziestaPierwsza' || wybrano=='dwudziestaDruga')
		{
			...
			var obrazek = document.getElementById("obrazek");
			obrazek.src="strefa-2-exl-3-en.jpg";
			var typ_oprawy1 = document.getElementById("1-typ_oprawy");
			typ_oprawy1.className = "row pokazane";
			var lista_typow_opraw = document.getElementById("wybor_typu_oprawy");
			for(i=1; i <= lista_typow_opraw.options.length; i++)
...
function Selekcja_typu_opraw(wybrano)
	{
		...
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="strefa-1-exf-nap-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
			for(i=1; i <= lista_konkretnej_oprawy.options.length; i++)
		...
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="strefa-2-exl-nap-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
			for(i=1; i <= lista_konkretnej_oprawy.options.length; i++)
		...
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="strefa-2-exl-wp-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
		...
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="strefa-2-exl-nas-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
			//Show_all_lista_konkretnych_opraw();
		...
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="strefa-1-exf-bul-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
			//Show_all_lista_konkretnych_opraw();
		...
		if(wybrano == 'surface' && dzial_opraw == 'VANDAL')
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="vandal-nap-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
			for(i=1; i <= lista_konkretnej_oprawy.options.length; i++)
		...
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="vandal-narozna-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
			//Show_all_lista_konkretnych_opraw();
		...
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="vandal-wpuszczana-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
			//Show_all_lista_konkretnych_opraw();
		...
		if(wybrano == 'surface' && dzial_opraw == 'PRISON')
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="prison-nap-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
			for(i=1; i <= lista_konkretnej_oprawy.options.length; i++)
		...
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="prison-narozna-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
			//Show_all_lista_konkretnych_opraw();
		...
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="prison-wpuszczana-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
			//Show_all_lista_konkretnych_opraw();
		...
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="factory-nap-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
			for(i=1; i <= lista_konkretnej_oprawy.options.length; i++)
		...
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="factory-nas-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
			//Show_all_lista_konkretnych_opraw();
		...
		{
			var obrazek = document.getElementById("obrazek");
			obrazek.src="factory-extrem-en.jpg";
			var konkretna_oprawa2 = document.getElementById("2-oprawa");
			konkretna_oprawa2.className = "row pokazane";
			var lista_konkretnej_oprawy = document.getElementById("wybor_konkretnej_oprawy");
			//Show_all_lista_konkretnych_opraw();
...
function Selekcja_konkretnych_opraw(wybrano)
	{
		...
		if(wybrano == 'EXL210LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/przeciwwybuchowe-oprawy-oswietleniowe/116-exl210led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/EXL210LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/Certyfikat_ATEX_KDB15ATEX0049X.pdf" target="_blank">ATEX certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Dopuszczenie%20CNBOP%20EXL210LED.pdf" target="_blank">CNBOP approval</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/EXL210LED_atest_PZH.pdf" target="_blank">PZH certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Deklaracje%20UE.zip" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'EXL310LED')
		{
			...
			document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/przeciwwybuchowe-oprawy-oswietleniowe/74-exl310led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL310LED/EXL310LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/Certyfikat_ATEX_KDB15ATEX0049X.pdf" target="_blank">ATEX certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL310LED/Deklaracja_zgodnosci_UE_Ex_EXL310LED.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL310LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'EXL380LED')
		{
			...
			document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/przeciwwybuchowe-oprawy-oswietleniowe/215-exl380led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL380LED/EXL380LED_karta_katalogowa.pdf" target="_blank">Data sheet</a><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/Certyfikat_ATEX_KDB15ATEX0049X.pdf" target="_blank">ATEX certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL380LED/Deklaracja_zgodnosci_UE_Ex_EXL380LED.pdf" target="_blank">EU declaration</a></p></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL380LED/EXL380LED_fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		var wybor_mocowania = document.getElementById("wybor_mocowania");
			...
			document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/przeciwwybuchowe-oprawy-oswietleniowe/226-exl390led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL390LED/EXL390LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/Certyfikat_ATEX_KDB15ATEX0049X.pdf" target="_blank">ATEX certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL390LED/Deklaracja_zgodnosci_UE_Ex_EXL390LED.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL390LED/EXL390LED_fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'EXF200LED')
		{
			...
			document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/przeciwwybuchowe-oprawy-oswietleniowe/232-exf200led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXF200LED/EXF200LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/Certyfikat_ATEX_KDB15ATEX0049X.pdf" target="_blank">ATEX certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXF200LED/EXF200LED_Deklaracja_zgodnosci.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXF200LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'EXF250LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/przeciwwybuchowe-oprawy-oswietleniowe/233-exf250led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXF250LED/EXF250LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/Certyfikat_ATEX_KDB15ATEX0049X.pdf" target="_blank">ATEX certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXF250LED/EXF250LED_Deklaracja_zgodnosci.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXF250LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'EXF300LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/przeciwwybuchowe-oprawy-oswietleniowe/234-exf300led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXF300LED/EXF300LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/Certyfikat_ATEX_KDB15ATEX0049X.pdf" target="_blank">ATEX certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXF300LED/EXF300LED_Deklaracja_zgodnosci.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXF300LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'FLX310LED')
		{
			...
			//obrazek.src = "FLX310LED/FLX310LED_oprawa.jpg";
					...
					document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/przeciwwybuchowe-oprawy-oswietleniowe/124-flx310led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/FLX310LED/FLX310LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/FLX310LED/EXA 15 ATEX 0050X EN.pdf" target="_blank">ATEX certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/FLX310LED/FLX310LED_Deklaracja_zgodnosci.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/FLX310LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'PLFMLED')
		{
			...
			document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/przeciwwybuchowe-oprawy-oswietleniowe/126-plfm-led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/PLFMLED/PLFMLED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/PLFM_LED/Certyfikat_PLFM_LED_EN.pdf" target="_blank">ATEX certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/PLFMLED/PLFMLED_Deklaracja_zgodnosci.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/PLFMLED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'PLFSLED')
		{
			...
			document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/przeciwwybuchowe-oprawy-oswietleniowe/128-plfs-led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/PLFSLED/PLFSLED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/PLFS_LED/Certyfikat_PLFS_LED_50_EN.pdf" target="_blank">ATEX certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/PLFSLED/PLFSLED_Deklaracja_zgodnosci.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/PLFSLED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == '040324LED')
		{
			...
			document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/przeciwwybuchowe-oprawy-oswietleniowe/130-040324-led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/0403.24_LED/0403.24_LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/0403.24_LED/Certyfikat_PLFS_LED_50_EN.pdf" target="_blank">ATEX certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/0403.24_LED/0403.24_LED_Deklaracja_zgodnosci.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/0403.24_LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INV320LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/wandaloodporne-oprawy-oswietleniowe-do-infrastruktury-kolejowej-i-tuneli/39-inv320led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED/INV320LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED/INV320LED_dopuszczenie_CNBOP.pdf" target="_blank">CNBOP approval</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED/INV320LED_dopuszczenie_PKP_PLK.pdf" target="_blank">PKP PLK approval</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED/Certyfikat_ENEC.pdf" target="_blank">Certyfikat ENEC</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED/INV320LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INV320LEDSF')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/wandaloodporne-oprawy-oswietleniowe-do-infrastruktury-kolejowej-i-tuneli/78-inv320led-sf" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED-SF/INV320LED-SF_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED-SF/INV320LED-SF_dopuszczenie_CNBOP.pdf" target="_blank">CNBOP approval</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED-SF/INV320LED-SF_dopuszczenie_PKP_PLK.pdf" target="_blank">PKP PLK approval</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED/Certyfikat_ENEC.pdf" target="_blank">Certyfikat ENEC</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED-SF/INV320LED-..-SF_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INV360LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/wandaloodporne-oprawy-oswietleniowe-do-infrastruktury-kolejowej-i-tuneli/80-inv360led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV360LED/INV360LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV360LED/INV360LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV360LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INS230')
		{
			...
			wersja_dodatkowa = "-II";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/wandaloodporne-oprawy-oswietleniowe-do-infrastruktury-kolejowej-i-tuneli/136-ins230" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INS230/INS230_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INS230/INS230_CE_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INS230/INS230_dopuszczenie_PKP_PLK.pdf" target="_blank">PKP PLK approval</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INS230/fotometria_INS230.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INS340')
		{
			...
			wersja_dodatkowa = "-II";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/wandaloodporne-oprawy-oswietleniowe-do-infrastruktury-kolejowej-i-tuneli/138-ins340" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INS340/INS340_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INS340/INS340_CE_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INS340/INS340_dopuszczenie_PKP_PLK.pdf" target="_blank">PKP PLK approval</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INS340/fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INP320LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-zakladow-penitencjarnych-i-wiezien/248-inp320led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_wandaloodporne_zaklady_penitencjarne/INV320LED/INV320LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_wandaloodporne_zaklady_penitencjarne/INP320LED/INP320LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INP320LEDSF')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-zakladow-penitencjarnych-i-wiezien/249-inp320led-sf" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_wandaloodporne_zaklady_penitencjarne/INP320LED-SF/INP320LED-SF_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produktyoprawy_wandaloodporne_zaklady_penitencjarne/INP320LED-SF/INP320LED-..-SF_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INP320LEDRC')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-zakladow-penitencjarnych-i-wiezien/256-inp320led-rc" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_wandaloodporne_zaklady_penitencjarne/INP320LED-RC/INP320LED-RC_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_wandaloodporne_zaklady_penitencjarne/INP320LED-RC/INP320LED-..-RC_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV320LED-..-RC/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INP360LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-zakladow-penitencjarnych-i-wiezien/250-inp60led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_wandaloodporne_zaklady_penitencjarne/INP360LED/INP360LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_wandaloodporne_zaklady_penitencjarne/INP360LED/INP360LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/wandaloodporne_oprawy_oswietleniowe_do_infrastruktury_kolejowej_i_tuneli/INV360LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INS340LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-zakladow-produkcyjnych-i-hal-magazynowych/91-ins340led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INS340LED/INS340LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INS340LED/INS340LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INS340LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INS370LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-zakladow-produkcyjnych-i-hal-magazynowych/94-ins370led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INS370LED/INS370LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INS370LED/INS370LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INS370LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'HPL440LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-zakladow-produkcyjnych-i-hal-magazynowych/244-hpl440led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/HPL440LED/HPL440LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/HPL440LED/HPL440_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/HPL440LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INX340LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-zakladow-produkcyjnych-i-hal-magazynowych/102-inx340led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INX340LED/INX340LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INX340LED/INX340LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INX340LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INX230LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-zakladow-produkcyjnych-i-hal-magazynowych/100-inx230led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INX230LED/INX230LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INX230LED/INX230LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INX230LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INS230LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-zakladow-produkcyjnych-i-hal-magazynowych/87-ins230led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INS230LED/INS230LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INS230LED/INS230LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INS230LED/INS230LED_dopuszczenie_CNBOP.pdf" target="_blank">CNBOP approval</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INS230LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'HPL430LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-zakladow-produkcyjnych-i-hal-magazynowych/98-hpl430led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/HPL430LED/HPL430LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/HPL430LED/HPL430LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/HPL430LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
		...
		if(wybrano == 'INS395LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-zakladow-produkcyjnych-i-hal-magazynowych/96-ins395led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INS395LED/INS395LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INS395LED/INS395LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/zaklady_produkcyjne_i_hale_magazynowe/INS395LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
			/*
		...
		if(wybrano == 'INS350LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-przemyslu-spozywczego-i-hodowli-zwierzat/262-ins350led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS350LED/INS350LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS350LED/INS350LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS350LED/INS350LED_atest_PZH.pdf" target="_blank">PZH certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS350LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
			/*
			var wybor_grupstrumienia = document.getElementsByTagName("optgroup");
			for(i=1; i < wybor_grupstrumienia.length; i++)
			{
		...
		if(wybrano == 'INS250LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-przemyslu-spozywczego-i-hodowli-zwierzat/108-ins250led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS250LED/INS250LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS250LED/INS250LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS250LED/Atest_PZH_dla_INS250_INS250LED.pdf" target="_blank">PZH certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS250LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
			/*
			var wybor_grupstrumienia = document.getElementsByTagName("optgroup");
			for(i=1; i < wybor_grupstrumienia.length; i++)
			{
		...
		if(wybrano == 'INS270LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-przemyslu-spozywczego-i-hodowli-zwierzat/110-ins270led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS270LED/INS270LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS270LED/INS270LED_EU_declaration.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS270LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
			/*
			var wybor_grupstrumienia = document.getElementsByTagName("optgroup");
			for(i=1; i < wybor_grupstrumienia.length; i++)
			{
		...
		if(wybrano == 'INS360LED')
		{
			...
			//obudowa_oprawy.className = "row pokazane";
				...
				document.getElementById("linki").innerHTML = 
				'<p style="font-size: 20px; color: #666666;">Downloads&nbsp;&nbsp;&nbsp;&nbsp;<em class="fa fa-download"></em></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/produkty/oprawy-oswietleniowe-do-przemyslu-spozywczego-i-hodowli-zwierzat/114-ins360led" target="_blank">Link to the website of the light fixture</a></p> <p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS360LED/INS360LED_karta_katalogowa.pdf" target="_blank">Data sheet</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS360LED/Atest_PZH_dla_INS360_INS360LED.pdf" target="_blank">EU declaration</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS360LED/Atest_PZH_dla_INS360_INS360LED.pdf" target="_blank">PZH certificate</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a href="https://atmlighting.pl/images/produkty/oprawy_oswietleniowe_do_przemyslu_spozywczego_i_hodowli_zwierzat/INS360LED/Fotometria.zip" target="_blank">Photometry of all versions</a></p><p><em class="fa fa-file-pdf">&nbsp;&nbsp;</em><a id=fotometriaDanegoTypu class="ukryte" href="" target="_blank">Photometry of selected type</a></p>';
			/*
			var wybor_grupstrumienia = document.getElementsByTagName("optgroup");
			for(i=1; i < wybor_grupstrumienia.length; i++)
			{
		...
		var obrazek = document.getElementById("obrazek");
		obrazek.src = nazwa_oprawy + wersja_dodatkowa + "/" + nazwa_oprawy + wersja_dodatkowa + "_oprawa_en.jpg";
...
function Selekcja_strumienia(wybrano)
	...
	resetKopiuj.className = "btn btn-secondary ukryte";
		...
		*/
		...
		wyborFotometrii.innerHTML = "Photometry of selected type";
		
		
		wyborFotometrii.href = "https://atmlighting.pl/images/produkty" + dzialWyborFotometrii + nazwa_oprawy + "/" + nazwa_oprawy + "-Fotometria-" + strumien_oprawy + ".zip";
...
function Selekcja_awaryjnosci(wybrano)
	...
	resetKopiuj.className = "btn btn-secondary ukryte";
		...
		if(wybrano == "brak")
			{
		wyborFotometrii.innerHTML = "Photometry of selected type";
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty" + dzialWyborFotometrii + nazwa_oprawy + "/Fotometria-" + strumien_oprawy +  ".zip";	
			}
		
		if(wybrano != "brak")
		{
		wyborFotometrii.innerHTML = "Photometry of selected type with emergency module";
		wyborFotometrii.href = "https://atmlighting.pl/images/produkty" + dzialWyborFotometrii + nazwa_oprawy + "/Fotometria-" + strumien_oprawy + wersje_awaryjne + ".zip";
		}
		/*
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "0600-E2" && wersje_awaryjne =="-ZB")
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-0600-E2-ZB.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "0600-E4" && wersje_awaryjne =="-ZB")
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-0600-E4-ZB.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "1200-E4" && wersje_awaryjne =="-ZB")
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-1200-E4-ZB.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "1200-E8" && wersje_awaryjne =="-ZB")
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-1200-E8-ZB.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "1500-E6" && wersje_awaryjne =="-ZB")
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-1500-E6-ZB.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "0600-E2" && wersje_awaryjne =="-A3")
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-0600-E2-A3.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "0600-E4" && wersje_awaryjne =="-A3")
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-0600-E4-A3.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "1200-E4" && wersje_awaryjne =="-A3")
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-1200-E4-A3.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "1200-E8" && wersje_awaryjne =="-A3")
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-1200-E8-A3.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "1500-E6" && wersje_awaryjne =="-A3")
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-1500-E6-A3.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "1500-E6" && (wersje_awaryjne =="brak" || wersje_awaryjne =="-ZBS" || wersje_awaryjne =="-ZBH" || wersje_awaryjne =="-ZBT" || wersje_awaryjne =="-ZBC" || wersje_awaryjne =="-ZBD" || wersje_awaryjne =="-ZBR" || wersje_awaryjne =="-ZBM" || wersje_awaryjne =="-DA"))
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-1500-E6.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "1200-E8" && (wersje_awaryjne =="brak" || wersje_awaryjne =="-ZBS" || wersje_awaryjne =="-ZBH" || wersje_awaryjne =="-ZBT" || wersje_awaryjne =="-ZBC" || wersje_awaryjne =="-ZBD" || wersje_awaryjne =="-ZBR" || wersje_awaryjne =="-ZBM" || wersje_awaryjne =="-DA"))
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-1200-E8.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "1200-E4" && (wersje_awaryjne =="brak" || wersje_awaryjne =="-ZBS" || wersje_awaryjne =="-ZBH" || wersje_awaryjne =="-ZBT" || wersje_awaryjne =="-ZBC" || wersje_awaryjne =="-ZBD" || wersje_awaryjne =="-ZBR" || wersje_awaryjne =="-ZBM" || wersje_awaryjne =="-DA"))
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-1200-E4.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "0600-E2" && (wersje_awaryjne =="brak" || wersje_awaryjne =="-ZBS" || wersje_awaryjne =="-ZBH" || wersje_awaryjne =="-ZBT" || wersje_awaryjne =="-ZBC" || wersje_awaryjne =="-ZBD" || wersje_awaryjne =="-ZBR" || wersje_awaryjne =="-ZBM" || wersje_awaryjne =="-DA"))
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-0600-E2.zip";
			}
			if(nazwa_oprawy == "EXL210LED" && strumien_oprawy == "0600-E4" && (wersje_awaryjne =="brak" || wersje_awaryjne =="-ZBS" || wersje_awaryjne =="-ZBH" || wersje_awaryjne =="-ZBT" || wersje_awaryjne =="-ZBC" || wersje_awaryjne =="-ZBD" || wersje_awaryjne =="-ZBR" || wersje_awaryjne =="-ZBM" || wersje_awaryjne =="-DA"))
			{
			wyborFotometrii.href = "https://atmlighting.pl/images/produkty/przeciwwybuchowe_oprawy_oswietleniowe/EXL210LED/Fotometria-EXL210LED-0600-E4.zip";
			}
			*/
...
function przeslij()
	{
		...
		{
		document.getElementById("klucz").innerHTML ="Product key : " +  nazwa_oprawy + "-" + strumien_oprawy + "-" + zasilanie_oprawy + "-" + okablowanie + "-" + uklad_dlawnic + material_dlawnic + wielkosc_dlawnic + "-" + obudowa_oprawy + "-" + klosz_oprawy + wersje_awaryjne + mocowanie + wersja_dodatkowa + wyposazenieDodatkowe;
		}
		if(wyposazenieDodatkowe == "-NL")
		{
		document.getElementById("klucz").innerHTML ="Product key : " +  nazwa_oprawy + "-" + strumien_oprawyNL + "-" + zasilanie_oprawy + "-" + okablowanie + "-" + uklad_dlawnic + material_dlawnic + wielkosc_dlawnic + "-" + obudowa_oprawy + "-" + klosz_oprawy + wersje_awaryjne + mocowanie + wersja_dodatkowa + wyposazenieDodatkowe;
		}
